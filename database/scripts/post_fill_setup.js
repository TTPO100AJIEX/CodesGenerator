...
await Database.executeMultiple(await readQueries(path.join(path.dirname(url.fileURLToPath(import.meta.url)), "post_fill_setup")));
console.info(`Finished database post-fill setup`);
await Database.end();